...
A small sample database (customers / subscriptions / billing) for practising `EXPLAIN (ANALYZE, BUFFERS)` and reading query plans.

## Contents

| File | Purpose |
|------|---------|
| `01_schema.sql` | Creates the `pg_lab` database and tables |
| `02_seed.sql` | Loads ~235k rows so plans are interesting |
| `03_explain_exercises.sql` | 8 `EXPLAIN (ANALYZE, BUFFERS)` exercises |
| `scenarios/` | Worked, annotated analyses of real plan output |
...
| Scenario | Plan type |
|----------|-----------|
| [scenarios/scenario_1.md](scenarios/scenario_1.md) | Seq Scan |
| [scenarios/scenario_2.md](scenarios/scenario_2.md) | Bitmap Index Scan |
| [scenarios/scenario_3.md](scenarios/scenario_3.md) | Nested Loop join |

---

**See also:** [../docs/performance-analysis.md](../docs/performance-analysis.md) · [../docs/cache.md](../docs/cache.md) · [../README.md](../README.md)
